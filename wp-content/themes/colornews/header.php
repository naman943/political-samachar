               ...
               ?>
                  <div class="logo">
                  	<?php if ( get_theme_mod('colornews_logo', '') != '') { ?>
                  		<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="http://localhost/Politics/wp-content/uploads/2017/07/ps.jpg" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>"></a>
					<?php } ?>
